...
title: "São Tomé time: straddling the equator on GMT"
description: "São Tomé, capital of the island nation on the equator, keeps Greenwich Mean Time year-round with no DST."
lastUpdated: "2026-03-23"
---

São Tomé sits almost exactly on the equator, on an island in the Gulf of Guinea about 250 kilometers off the west coast of Africa. As the capital of [Sao Tome and Principe](/country/sao-tome-and-principe), it keeps Greenwich Mean Time (UTC+0) all year, with no daylight saving adjustment.
...
[9am in São Tomé is 9am in London](/when/9am-sao-tome/london) in winter. During British Summer Time, London advances to UTC+1 and the gap opens to one hour.

## Sources
- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Governo de São Tomé e Príncipe](https://www.gov.st)
