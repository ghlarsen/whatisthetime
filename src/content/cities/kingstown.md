...
title: "Kingstown time: Caribbean capital permanently at UTC-4"
description: "Kingstown, capital of Saint Vincent and the Grenadines, runs on Atlantic Standard Time, UTC-4, year-round. No daylight saving."
...
The Vincentian economy has historically been based on banana exports. The banana trade operates on refrigerated shipping schedules tied to European markets, meaning that the city's port works to European rhythms regardless of what time the local clock shows.

[9am in Kingstown is 1pm in London](/when/9am-kingstown/london) in winter, four hours behind GMT.

## Sources
- [IANA Time Zone Database - America/St_Vincent](https://data.iana.org/time-zones/tz-link.html)
- [Statistical Office of Saint Vincent and the Grenadines](https://stats.gov.vc)
