...
title: "Kourou time: space launches from UTC-3"
description: "Kourou, French Guiana, hosts the Guiana Space Centre, Europe's primary spaceport. The city runs on French Guiana Time, UTC-3, year-round."
...
At 5 degrees north, daylight in Kourou is remarkably stable: close to 12 hours every day of the year. The rainy seasons (December-July broadly, with a dry break) structure the humidity and launch weather more than the clock does.

[9am in Kourou is noon in London](/when/9am-kourou/london) in winter, three hours behind GMT.

## Sources
- [IANA Time Zone Database - America/Cayenne](https://data.iana.org/time-zones/tz-link.html)
- [European Space Agency - Guiana Space Centre](https://www.esa.int/Enabling_Support/Space_Transportation/Europe_s_Spaceport)
