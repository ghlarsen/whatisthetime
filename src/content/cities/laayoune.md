...
title: "Laayoune time: Western Sahara's largest city and its shifting clocks"
description: "Laayoune (El Aaiún) uses Morocco Time, aligning with Africa/El_Aaiun. Western Sahara follows Morocco's timezone, which includes daylight saving and Ramadan suspensions."
lastUpdated: "2026-03-23"
---

Laayoune is the largest city in Western Sahara, a disputed territory administered by Morocco but claimed by the Sahrawi Arab Democratic Republic. The city runs on Africa/El_Aaiun time, which follows Morocco's clock: UTC+1 in standard time, UTC+2 during daylight saving, with the unusual practice of reverting to UTC+1 during Ramadan regardless of DST.
...
[9am in Laayoune is 8am in London](/when/9am-laayoune/london) during standard time, one hour ahead.

## Sources
- [IANA Time Zone Database - Africa/El_Aaiun](https://data.iana.org/time-zones/tz-link.html)
