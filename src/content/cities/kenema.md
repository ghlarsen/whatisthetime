...
title: "Kenema time: diamond district on Greenwich Mean Time"
description: "Kenema, Sierra Leone's third-largest city, runs on GMT year-round. Its timezone exactly matches UTC, with no daylight saving observed."
...
[Freetown](/freetown) on the coast observes the same time. The shared timezone across all of Sierra Leone means there are no internal conversion headaches for businesses and families moving between cities.

[Noon in Kenema is noon in London in winter](/when/12pm-kenema/london), an exact match when the UK is on GMT. When Britain moves to BST in summer, London jumps an hour ahead of Kenema.
