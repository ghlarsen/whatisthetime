...
title: "Sovetsk time: the city that was Tilsit, on Kaliningrad Time"
description: "Sovetsk, formerly Tilsit, keeps Kaliningrad Time (UTC+2) year-round, the westernmost timezone in Russia."
lastUpdated: "2026-03-23"
---

Sovetsk sits on the Neman River at the border between Russia's Kaliningrad exclave and Lithuania. It was the Prussian city of Tilsit until 1945, when the Soviet Union took the territory and renamed it. The city keeps Kaliningrad Time (UTC+2) all year, the same offset as the Kaliningrad region, which is Russia's westernmost territory and geographically separated from the Russian mainland by Lithuania and Belarus.
...
- [Kaliningrad Regional Government](https://gov39.ru)
