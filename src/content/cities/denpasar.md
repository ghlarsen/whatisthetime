...
title: "Time in Denpasar: Bali's Capital at Central Indonesian Time"
description: "Denpasar, Bali's capital, uses Central Indonesia Time (WITA, UTC+8). Bali sits in Indonesia's middle timezone zone, one hour ahead of Jakarta."
lastUpdated: "2026-03-23"
---

Denpasar, the capital of Bali, uses Central Indonesia Time (WITA), UTC+8, year-round. The IANA identifier is `Asia/Makassar`. Indonesia is divided into three timezone zones: WIB (UTC+7) for Sumatra and Java, WITA (UTC+8) for Bali and the islands between, and WIT (UTC+9) for eastern Indonesia including Papua. No daylight saving is observed anywhere in Indonesia.
...
- [Badan Meteorologi, Klimatologi, dan Geofisika (BMKG), Indonesia](https://www.bmkg.go.id/)
