...
title: "Sokodé time: Togo's second city on Greenwich Mean Time"
description: "Sokodé, in Togo's center near the Atakora mountain range, runs on GMT year-round with no daylight saving."
lastUpdated: "2026-03-23"
---

Sokodé is [Togo](/country/togo)'s second-largest city, positioned in the center of the country near the Fazao-Malfakassa National Park and the foothills of the Atakora range. It runs on Greenwich Mean Time (UTC+0) all year, the same fixed offset as the capital Lomé to the south.
...
[9am in Sokodé is 9am in London](/when/9am-sokode/london) in winter. During British Summer Time, London advances to UTC+1 and a one-hour gap opens.

## Sources
- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [République Togolaise - Gouvernement](https://www.gouvernement.tg)
