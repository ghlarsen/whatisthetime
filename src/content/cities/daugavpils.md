...
title: "Time in Daugavpils: Latvia's Eastern City at UTC+2/+3"
description: "Daugavpils uses Eastern European Time (EET, UTC+2 in winter; EEST, UTC+3 in summer). As Latvia's second-largest city and a largely Russian-speaking community, Daugavpils has a complex relationship with its national clock."
lastUpdated: "2026-03-23"
---

Daugavpils, Latvia's second-largest city, sits in the country's southeastern corner, close to the Lithuanian, Belarusian, and Russian borders. It shares the IANA timezone `Europe/Riga`: UTC+2 in winter (Eastern European Time) and UTC+3 in summer (EEST), following EU seasonal clock change rules. Latvia shifts its clocks with the rest of the EU.
...
- [Latvijas Vides, Ģeoloģijas un Meteoroloģijas Centrs (LVĢMC)](https://www.meteo.lv/)
