...
title: "Time in Dallas: Central Time in Texas's Largest Metro"
description: "Dallas runs on Central Time (CST, UTC-6 in winter; CDT, UTC-5 in summer). Texas observes standard US daylight saving rules, making Dallas six hours behind London most of the year."
lastUpdated: "2026-03-23"
---

Dallas-Fort Worth is the fourth-largest metropolitan area in the United States, running on Central Time with standard US daylight saving: UTC-6 in winter, UTC-5 in summer. The IANA identifier `America/Chicago` covers the city. Clocks spring forward in March and fall back in November.
...
- [National Institute of Standards and Technology (NIST)](https://www.nist.gov/time-frequency)
