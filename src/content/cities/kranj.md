...
title: "Kranj time: Slovenia's fourth city at the foot of the Alps"
description: "Kranj uses Central European Time, UTC+1 in winter and UTC+2 during CEST. The city sits beneath the Kamnik-Savinja Alps, gateway to the Julian Alps."
...
Kranj is also known for its industrial output, particularly in electronics and precision manufacturing. These factories operate on shift patterns that minimize the relevance of solar time entirely, aligned instead with European supply chain schedules.

[Ljubljana](/ljubljana) is just 25 kilometers to the southeast and keeps the same clock. [9am in Kranj is 8am in London](/when/9am-kranj/london) in winter, one hour ahead of GMT.
