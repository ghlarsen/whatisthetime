...
title: "Nadi time: Fiji's gateway city and the Pacific's daylight saving experiment"
description: "Nadi runs on FJT (UTC+12) in winter and UTC+13 during daylight saving, making it one of the first places in the world to greet each new day."
lastUpdated: "2026-03-23"
---

Nadi is the entry point for most of the world's visitors to Fiji. Its international airport handles the long-haul flights from Australia, New Zealand, the United States, and Asia, and the town itself is built largely to serve the tourism economy. But Nadi's position in time is genuinely remarkable: during daylight saving, it sits at UTC+13, among the furthest ahead of UTC of any inhabited place on earth.
...
[9am in Nadi is 9pm the previous day in London](/when/9am-nadi/london).

## Sources
- [IANA Time Zone Database - Pacific/Fiji](https://data.iana.org/time-zones/tz-link.html)
- [Fiji Meteorological Service](https://www.met.gov.fj/)
