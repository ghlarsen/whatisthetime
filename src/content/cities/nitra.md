...
title: "Nitra time: one of Central Europe's oldest cities on CET/CEST"
description: "Nitra, Slovakia's oldest city with over a thousand years of documented history, runs on CET (UTC+1 in winter, UTC+2 in summer) in the Nitra Valley."
lastUpdated: "2026-03-23"
---

Nitra has been continuously inhabited since the Paleolithic, and the castle on the dolerite hill above the city has been fortified since at least the 9th century when it was the seat of the Principality of Nitra. The first written mention of a Slavic church dates to 828 AD from this location. The hill and castle still dominate the city, and the cathedral inside the castle complex is Slovakia's oldest.
...
[9am in Nitra is 8am in London](/when/9am-nitra/london), the same as [Bratislava](/bratislava).

## Sources
- [IANA Time Zone Database - Europe/Bratislava](https://data.iana.org/time-zones/tz-link.html)
- [City of Nitra](https://www.nitra.sk/)
