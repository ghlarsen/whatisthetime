...
title: "Sfax time: Tunisia's industrial capital on Central European Time"
description: "Sfax, Tunisia's second city and economic engine, keeps Central European Time (UTC+1) year-round with no DST."
lastUpdated: "2026-03-23"
---

Sfax is [Tunisia](/country/tunisia)'s second-largest city and the economic center of the country's south, driven by olive oil, phosphate processing, and a strong commercial culture. It runs on Central European Time (UTC+1) all year, a fixed offset Tunisia has maintained without daylight saving since 2009.
...
[9am in Sfax is 8am in London](/when/9am-sfax/london) in winter. During British Summer Time, London advances to UTC+1 and matches Sfax exactly.

## Sources
- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Municipalité de Sfax](https://www.municipalitesfax.tn)
