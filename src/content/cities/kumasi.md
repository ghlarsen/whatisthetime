...
title: "Kumasi time: Ashanti capital on Greenwich Mean Time"
description: "Kumasi, Ghana's second city and the historical capital of the Ashanti kingdom, runs on GMT year-round. No daylight saving is observed."
...
Ghana adopted UTC+0 in 1960, abandoning the British colonial practice of GHST (Greenwich Mean Time minus 20 minutes), which had been used to split the difference with local solar time. The country went all in on GMT and stayed.

[Accra](/accra) on the coast keeps the same time. [Noon in Kumasi is noon in London in winter](/when/12pm-kumasi/london), an exact GMT match.
