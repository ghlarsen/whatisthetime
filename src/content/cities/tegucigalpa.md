...
title: "Tegucigalpa time: Central Standard Time, no DST"
description: "Tegucigalpa, Honduras's capital, keeps Central Standard Time (UTC-6) year-round. Honduras abandoned daylight saving time in 1987 and hasn't returned."
lastUpdated: "2026-03-23"
---

Tegucigalpa is one of the few Central American capitals that never settled into a flat grid. The city tumbles across hillsides, each neighborhood clinging to its own slope, connected by a road system that grew around the terrain rather than imposing on it. Getting somewhere across town takes longer than maps suggest.
...
- [Instituto Nacional de Estadística de Honduras](https://www.ine.gob.hn)
