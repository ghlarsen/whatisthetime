...
title: "Korhogo time: northern Ivory Coast on Greenwich Mean Time"
description: "Korhogo, Ivory Coast's largest northern city, runs on GMT year-round. Ivory Coast has never observed daylight saving time."
...
Korhogo's cotton market connects the north to Abidjan on the coast. Agricultural schedules here follow the harmattan season (November-February) and the rain calendar, not any clock adjustment. Farmers in the surrounding savanna have worked around solar time for generations regardless of what the administrative clock does.

[Noon in Korhogo is noon in London in winter](/when/12pm-korhogo/london), GMT to GMT. When Britain switches to BST in summer, London runs an hour ahead.

## Sources
- [IANA Time Zone Database - Africa/Abidjan](https://data.iana.org/time-zones/tz-link.html)
- [Institut National de la Statistique Côte d'Ivoire](https://www.ins.ci)
