...
title: "Mosul time: the city where two rivers once kept different clocks"
description: "Mosul sits on the Tigris at 36 degrees north, sharing Iraq Standard Time with Baghdad but carrying a history of timekeeping far older than any modern timezone."
...
[9am in Mosul is 7am in London](/when/9am-mosul/london), a gap that matters for journalists and aid workers coordinating between the two cities.

## Sources
- [IANA Time Zone Database - Asia/Baghdad](https://data.iana.org/time-zones/tz-link.html)
- [United Nations Assistance Mission for Iraq](https://unami.unmissions.org/)
