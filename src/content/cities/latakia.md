...
title: "Latakia time: Syria's Mediterranean port at UTC+3"
description: "Latakia uses Syria Time, UTC+3, year-round since Syria suspended daylight saving in 2022. The country had previously observed DST."
lastUpdated: "2026-03-23"
---

Latakia is Syria's main seaport, a Mediterranean city on a coast that has been inhabited since at least the Bronze Age. Ancient Ugarit, one of the earliest cities to use a writing system, stood nearby. Today the city runs on Asia/Damascus time: UTC+3, year-round. Syria suspended daylight saving in 2022, staying on permanent summer time.
...
[9am in Latakia is 6am in London](/when/9am-latakia/london), three hours ahead.

## Sources
- [IANA Time Zone Database - Asia/Damascus](https://data.iana.org/time-zones/tz-link.html)
- [Central Bureau of Statistics Syria](http://www.cbssyr.sy)
