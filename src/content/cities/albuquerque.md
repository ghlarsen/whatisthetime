...
title: "Albuquerque time: Mountain Time at the edge of the high desert"
description: "New Mexico's largest city runs on Mountain Time, UTC-7 in winter and UTC-6 in summer, with the longest twilights in the US thanks to its 5,300-foot elevation and clear dry air."
lastUpdated: "2026-03-23"
---

Albuquerque sits at 5,300 feet elevation in the Rio Grande valley, flanked by the Sandia Mountains to the east. The high desert air is clear and dry, and this changes what time looks like here. Sunsets are long, drawn-out spectacles: the mountains go pink, then orange, then purple, and the light fades slowly because there is almost no humidity to diffuse it. The golden hour lasts an actual hour.
...
[9am in Albuquerque is 4pm in London](/when/9am-albuquerque/london) during European winter.

## Sources
- [IANA Time Zone Database - America/Denver](https://data.iana.org/time-zones/tz-link.html)
