...
title: "Malé time: UTC+5 in the Indian Ocean's sinking capital"
description: "Malé, capital of the Maldives, runs on Maldives Time, UTC+5, year-round. The world's lowest-lying capital sits barely a meter above sea level."
lastUpdated: "2026-03-23"
---

Malé is the capital of the Maldives and one of the most densely populated cities on earth, a tight cluster of buildings on an island barely two kilometers across. It runs on Maldives Time, UTC+5, with no daylight saving. The [Maldives](/country/maldives) keep this single fixed offset across all their islands.
...
## Sources
- [IANA Time Zone Database - Indian/Maldives](https://data.iana.org/time-zones/tz-link.html)
- [National Bureau of Statistics Maldives](https://statisticsmaldives.gov.mv)
