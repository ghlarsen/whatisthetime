...
title: "Lomé time: Togo's coastal capital on Greenwich Mean Time"
description: "Lomé, Togo's capital on the Gulf of Guinea, runs on GMT year-round. It shares UTC+0 with its neighbor Accra in Ghana, just across the border."
...
At 6 degrees north, Lomé has near-constant daylength. The harmattan season in winter brings haze and dust. The rainy seasons punctuate the year. But the clock barely varies.

[Kara](/kara) in the north of Togo keeps the same time. [Noon in Lomé is noon in London in winter](/when/12pm-lome/london), GMT to GMT.

## Sources
- [IANA Time Zone Database - Africa/Lome](https://data.iana.org/time-zones/tz-link.html)
- [Direction Générale de la Statistique et de la Comptabilité Nationale Togo](https://www.dgscn.tg)
