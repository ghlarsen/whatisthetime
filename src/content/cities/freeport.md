...
title: "Time in Freeport: The Bahamas' Second City at Eastern Time"
description: "Freeport, on Grand Bahama Island, uses Eastern Time (EST, UTC-5 in winter; EDT, UTC-4 in summer). The Bahamas follows US Eastern Time DST rules, keeping the islands in sync with Florida."
...
[Convert 9am Freeport time to London](/when/9am-freeport/london)

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Bahamas Meteorological Department](https://www.bahamasweather.org.bs/)
- Johnson, Doris. *The Quiet Revolution in the Bahamas*. Family Islands Press, 1972.
