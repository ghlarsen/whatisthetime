...
title: "Basel time: where three countries share one clock at a train station"
description: "Basel runs on Central European Time, UTC+1 in winter and UTC+2 in summer, in a city where Switzerland, France, and Germany meet and share the same clock."
...
[9am in Basel is 8am in London](/when/9am-basel/london) during European winter.

## Sources
- [IANA Time Zone Database - Europe/Zurich](https://data.iana.org/time-zones/tz-link.html)
- [Kanton Basel-Stadt](https://www.bs.ch)
