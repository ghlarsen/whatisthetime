...
title: "Time in East Jerusalem: A City Where the Clock Itself Is Contested"
description: "East Jerusalem uses Palestine Standard Time (PST, UTC+2 in winter; PDT, UTC+3 in summer), under the IANA timezone Asia/Hebron. Meanwhile, West Jerusalem uses Israel Standard Time on a different DST schedule."
...
[Convert 9am East Jerusalem time to London](/when/9am-east-jerusalem/london)

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Palestinian Meteorological Authority](https://www.pma.ps/)
