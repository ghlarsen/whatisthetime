...
title: "Nampula time: Mozambique's northern capital on Central Africa Time"
description: "Nampula, Mozambique's third-largest city and northern commercial hub, runs on CAT (UTC+2) year-round with no daylight saving."
lastUpdated: "2026-03-23"
---

Nampula is the commercial and transport hub for northern Mozambique, sitting on a flat plain surrounded by inselbergs, those steep rocky outcrops that rise abruptly from the surrounding landscape. The Mozambique Island, a UNESCO World Heritage Site with 500 years of Swahili-Portuguese history, lies about 160 kilometers to the northeast. Nampula is its mainland gateway.
...
[9am in Nampula is 7am in London](/when/9am-nampula/london).

## Sources
- [IANA Time Zone Database - Africa/Maputo](https://data.iana.org/time-zones/tz-link.html)
- [Instituto Nacional de Estatística de Moçambique](https://www.ine.gov.mz/)
