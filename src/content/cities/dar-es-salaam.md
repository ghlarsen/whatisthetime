...
title: "Time in Dar es Salaam: East African Time on the Indian Ocean"
description: "Dar es Salaam uses East Africa Time (EAT, UTC+3) year-round. Tanzania has never observed daylight saving. The city runs on a parallel Swahili time system that starts the clock at sunrise."
lastUpdated: "2026-03-23"
---

Dar es Salaam, Tanzania's commercial capital and largest city, runs on East Africa Time, UTC+3, year-round. The IANA identifier `Africa/Dar_es_Salaam` covers the city. No daylight saving has ever been observed in Tanzania.
...
- Nurse, Derek and Thomas Spear. *The Swahili: Reconstructing the History and Language of an African Society*. University of Pennsylvania Press, 1985.
