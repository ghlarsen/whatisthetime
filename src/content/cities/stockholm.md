...
title: "Stockholm time: the midnight sun city and its extreme seasonal clock"
description: "Stockholm keeps Central European Time, but at 59 degrees north the seasonal difference in daylight is so extreme it defines the character of each season."
lastUpdated: "2026-03-23"
---

Stockholm sits on the Baltic coast at 59 degrees north, spread across fourteen islands where Lake Mälaren meets the sea. It runs on Central European Time (UTC+1 in winter, UTC+2 in summer), the same clock as the rest of [Sweden](/country/sweden) and continental Central Europe.
...
[Stavanger](/stavanger) in Norway and [Copenhagen](/copenhagen) in Denmark share the same Central European clock.

[9am in Stockholm is 8am in London](/when/9am-stockholm/london) in winter, 7am during British Summer Time.

## Sources
- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Stockholm City](https://start.stockholm)
