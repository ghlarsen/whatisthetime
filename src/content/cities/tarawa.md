...
title: "Tarawa time: UTC+12 on the edge of tomorrow"
description: "Tarawa, the capital of Kiribati, runs at UTC+12, placing it among the first inhabited places on Earth to greet each new day."
lastUpdated: "2026-03-23"
---

Tarawa is an atoll, a thin strip of coral and sand in the central Pacific, and the capital of [Kiribati](/country/kiribati). It sits almost exactly on the equator, which means sunrise and sunset vary by only about 20 minutes across the entire year. There is no dramatic summer or winter light here. Just reliable, equatorial consistency.
...
## Sources
- [IANA Time Zone Database - Pacific/Tarawa](https://data.iana.org/time-zones/tz-link.html)
