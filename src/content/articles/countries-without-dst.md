...
description: "Most of the world's population never changes their clocks, and the reasons range from geography to imperial history to a national referendum that failed."
...
[Japan](/country/japan) tried daylight saving once. It did not go well.
...
[China](/country/china) observed daylight saving time from 1986 through 1991. It was abolished in 1992 and has not returned.
...
In 2014, [Russia](/country/russia) reversed course, moving back to permanent winter time (the standard offset) and eliminating the summer advance rather than the winter one. Russia now operates on UTC+3 in Moscow year-round, without transitions.
...
The [summertime transition](/summertime) page covers the mechanics of how clock changes work in the countries that still use them. But the trend line is clear: over the past decade, more countries have abolished daylight saving than have adopted it.
...
- European Commission. "Public Consultation on Summertime Arrangements." July 2018. [ec.europa.eu](https://ec.europa.eu)
- Japan Cabinet Office. Report on Daylight Saving Time Consideration for Tokyo 2020 Olympics, 2018.
- IANA Time Zone Database. Asia, Europe, and Antarctica zone history files. [iana.org/time-zones](https://www.iana.org/time-zones)
