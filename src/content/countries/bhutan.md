...
country: "Bhutan"
slug: "bhutan"
title: "Time in Bhutan: UTC+6, Gross National Happiness, and the Country That Measured Wellbeing Before Output"
description: "Bhutan uses Bhutan Time (BTT), UTC+6 year-round, with no daylight saving. The small Himalayan kingdom is famous for measuring Gross National Happiness as a development metric, and its time policy reflects the same orientation: simple, stable, oriented toward wellbeing over optimization."
...
- [Centre for Bhutan Studies and GNH Research](https://www.bhutanstudies.org.bt/)
- [Royal Government of Bhutan — Tourism Council](https://www.tourism.gov.bt/)
