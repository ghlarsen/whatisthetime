...
title: "Time in the Republic of the Congo: WAT, UTC+1, and the Two Congos"
description: "The Republic of the Congo (Congo-Brazzaville) observes West Africa Time (UTC+1) year-round. It sits across the Congo River from the much larger Democratic Republic of the Congo, and the two countries sharing the same river use the same timezone."
...
- IANA timezone: `Africa/Brazzaville`
- UTC offset: +01:00 year-round
- No DST transitions
- Shares offset and effectively the same timezone as `Africa/Kinshasa` (DRC western provinces)

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Agence Française de Développement: Congo](https://www.afd.fr/)
- Birmingham, David. *The Decolonization of Africa*. Taylor and Francis, 1995.
- [UNESCO: Brazzaville in WWII context](https://www.unesco.org/)
