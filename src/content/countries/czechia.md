...
country: "Czechia"
slug: "czechia"
title: "Time in Czechia: CET, Franz Kafka's Prague, and the Clock That Outlasted Three Republics"
description: "Czechia uses Central European Time (CET, UTC+1 in winter, UTC+2 in summer). Prague's extraordinary astronomical clock has been measuring time since 1410, and the country's relationship with timekeeping runs through the Habsburg Empire, Czechoslovakia, and into the present."
...
The dial shows:
- Bohemian time (the old system counting hours from sunset, where sunset is hour 1 and midnight is approximately hour 6)
- German/standard time (the modern 12-hour system)
- Italian time (hours counted from one hour after sunset)
- Babylonian time (hours of unequal length, changing by season)
...
- [Prague City Hall — Astronomical Clock](https://www.prague.eu/en/object/places/3129/astronomical-clock)
- [European Parliament Resolution on Seasonal Time Changes, 2019](https://www.europarl.europa.eu/doceo/document/TA-8-2019-0318_EN.html)
- Kafka, Franz. *The Trial*. Translated by Breon Mitchell. Schocken Books, 1998.
- [Pilsner Urquell Brewery](https://www.pilsnerurquell.com/en/)
