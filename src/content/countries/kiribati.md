...
country: "Kiribati"
slug: "kiribati"
title: "Time in Kiribati: The Country That Moved the Date Line"
description: "Kiribati spans the widest longitude of any country and straddles three timezones: UTC+12, UTC+13, and UTC+14. In 1995, it moved the International Date Line around itself to keep the entire nation in the same calendar day."
...
- `Pacific/Tarawa` (UTC+12): Gilbert Islands, including the capital
- `Pacific/Kanton` (UTC+13): Phoenix Islands
- `Pacific/Kiritimati` (UTC+14): Line Islands, including Christmas Island
...
- [Government of Kiribati](https://www.gov.ki/)
- [SPREP: Pacific climate change and sea level](https://www.sprep.org/)
- [Pacific Community (SPC): Kiribati statistics](https://www.spc.int/)
- Tong, Anote. Testimony to UN General Assembly on climate displacement, multiple sessions.
