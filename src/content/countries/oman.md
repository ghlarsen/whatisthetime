...
country: "Oman"
slug: "oman"
title: "Time in Oman: Arabia Standard Time and the Sultanate That Never Blinked"
description: "Oman runs on Arabia Standard Time (UTC+4), shares it with the UAE, and has never observed daylight saving time. In a region of complexity, Oman keeps things elegantly simple."
...
- IANA timezone: `Asia/Muscat`
- UTC offset: +04:00 year-round
- No DST transitions
- Shares offset with `Asia/Dubai` (UAE), though the identifiers are distinct

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [National Meteorological Service of Oman](https://www.met.gov.om/)
- [Directorate General of Meteorology and Air Navigation, Oman](https://www.met.gov.om/en/)
- Wikan, Unni. *Behind the Veil in Arabia: Women in Oman*. University of Chicago Press, 1982.
- [Royal Geographical Society: Oman Geography](https://www.rgs.org/)
