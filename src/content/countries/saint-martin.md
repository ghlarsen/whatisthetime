...
- IANA timezone (French side): `America/Marigot` (UTC-4)
- IANA timezone (Dutch side): `America/Lower_Princes` (UTC-4)
- Both sides observe UTC-4 year-round with no DST
- See also the Sint Maarten entry
...
- Treaty of Concordia, 1648, historical text via French National Archives
