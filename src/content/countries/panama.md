...
country: "Panama"
slug: "panama"
title: "Time in Panama: EST Year-Round, Where Two Oceans Meet at One Clock"
description: "Panama observes UTC-5 year-round with no daylight saving time, keeping the same offset as US Eastern Standard Time regardless of season. This is partly practical, partly structural: the Panama Canal runs on its own rhythm."
...
- IANA timezone: `America/Panama`
- UTC offset: -05:00 year-round
- No DST transitions
- Same as US Eastern Standard Time; note the offset from US Eastern Daylight Time (UTC-4) during North American summer

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Panama Canal Authority](https://www.pancanal.com/eng/)
- [Torrijos-Carter Treaties, 1977, US Department of State](https://history.state.gov/milestones/1977-1980/panama-canal)
