...
country: "Paraguay"
slug: "paraguay"
title: "Time in Paraguay: PYT, DST, and the Landlocked Country That Survived Everything"
description: "Paraguay observes Paraguay Time (UTC-4) with daylight saving time that shifts it to UTC-3 in summer. It is one of only two landlocked countries in South America and has a timezone history as turbulent as its political one."
...
- IANA timezone: `America/Asuncion`
- UTC offset: -04:00 (winter), -03:00 (DST, approximately October through March)
- DST transition dates can vary; verify for specific years
- DST currently observed; check IANA database for current rules

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Dirección Meteorológica de Paraguay](http://www.meteorologia.gov.py/)
- [Itaipu Binacional](https://www.itaipu.gov.py/en)
- Whigham, Thomas. *The Paraguayan War: Volume 1, Causes and Early Conduct*. University of Nebraska Press, 2002.
