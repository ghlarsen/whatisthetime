...
slug: "saudi-arabia"
title: "Time in Saudi Arabia: AST, UTC+3, and the Country That Runs on Prayer Time"
description: "Saudi Arabia observes Arabia Standard Time (UTC+3) year-round with no daylight saving time. The country's daily schedule is organized around the five Islamic prayers, which are calculated from sunrise and sunset rather than from the clock."
...
- **Fajr**: before sunrise, calculated based on when the sky begins to lighten
- **Dhuhr**: just after solar noon
- **Asr**: afternoon, when an object's shadow equals its height
- **Maghrib**: just after sunset
- **Isha**: when the sky is fully dark
...
- IANA timezone: `Asia/Riyadh`
- UTC offset: +03:00 year-round
- No DST transitions
- Shares UTC+3 with Kuwait, Qatar (which uses `Asia/Qatar`), and other Gulf states

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Saudi Arabian Standards Organization (SASO)](https://www.saso.gov.sa/)
- [General Authority of Meteorology and Environmental Protection (PME), Saudi Arabia](https://www.pme.gov.sa/)
- Lacey, Robert. *Inside the Kingdom: Kings, Clerics, Modernists, Terrorists, and the Struggle for Saudi Arabia*. Viking, 2009.
