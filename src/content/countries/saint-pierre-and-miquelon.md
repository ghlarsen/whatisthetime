...
title: "Time in Saint Pierre and Miquelon: France's Last Foothold in North America"
description: "Saint Pierre and Miquelon is a French overseas collectivity just off the coast of Newfoundland, Canada. It observes UTC-3 in winter and UTC-2 in summer, making it the only territory in the Americas to observe a half-hour offset from its Canadian neighbors."
...
- IANA timezone: `America/Miquelon`
- UTC offset: -03:00 (winter), -02:00 (DST)
- DST follows French/EU schedule (last Sunday March and October)
- Note: This differs from Newfoundland's UTC-3:30 offset by 30 minutes

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Collectivité de Saint-Pierre-et-Miquelon](https://www.saint-pierre-et-miquelon.fr/)
- [INSEE: Saint-Pierre-et-Miquelon statistics](https://www.insee.fr/fr/statistiques/3698020)
- Mowat, Farley. *The New Founde Land*. McClelland and Stewart, 1989. (Context on Newfoundland and Saint Pierre)
