...
country: "Suriname"
slug: "suriname"
title: "Time in Suriname: UTC-3, the Dutch-Speaking Amazon, and the Strangest Timezone in the Americas"
description: "Suriname observes UTC-3 year-round, making it the only country in mainland South America that does not share its timezone with any of its neighbors. It is also the only Dutch-speaking country in South America."
...
- IANA timezone: `America/Paramaribo`
- UTC offset: -03:00 year-round
- No DST transitions
- Changed from UTC-3:30 to UTC-3:00 in 1984

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Meteorologische Dienst Suriname](https://www.meteo.sr/)
- [UNESCO: Historic Inner City of Paramaribo](https://whc.unesco.org/en/list/940/)
- Price, Richard. *First-Time: The Historical Vision of an African American People*. University of Chicago Press, 1983. (On Saramaka history)
