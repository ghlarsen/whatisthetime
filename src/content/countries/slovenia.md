...
country: "Slovenia"
slug: "slovenia"
title: "Time in Slovenia: CET, DST, and Europe's Most Overlooked Alpine Country"
description: "Slovenia observes Central European Time (UTC+1 in winter, UTC+2 in summer). The small country between Italy, Austria, Hungary, and Croatia is consistently ranked among the most livable in the world and is often confused with Slovakia despite being 600 kilometers away."
...
Slovenia uses Central European Time (UTC+1). DST observed: clocks advance to UTC+2 in summer. IANA: `Europe/Ljubljana`.

**Key facts about time in Slovenia**
- Timezone: Central European Time (CET)
- UTC offset: +01:00 (winter), +02:00 (summer DST)
- DST: yes
- IANA identifier: `Europe/Ljubljana`
- Capital: Ljubljana
...
- IANA timezone: `Europe/Ljubljana`
...
- [Slovenian Environment Agency (ARSO), meteorology](https://www.arso.gov.si/)
