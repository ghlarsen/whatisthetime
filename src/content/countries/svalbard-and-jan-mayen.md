...
title: "Time in Svalbard and Jan Mayen: CET in the Arctic, Where the Sun Doesn't Set for Months"
description: "Svalbard and Jan Mayen observe Central European Time (UTC+1 in winter, UTC+2 in summer). Svalbard sits at 74-81 degrees North latitude, making it one of the most extreme high-latitude places on Earth to observe DST, where the midnight sun makes clock-based time feel particularly abstract."
...
Svalbard and Jan Mayen uses Central European Time (UTC+1). DST observed: clocks advance to UTC+2 in summer. IANA: `Arctic/Longyearbyen`.

**Key facts about time in Svalbard and Jan Mayen**
- Timezone: Central European Time (CET)
- UTC offset: +01:00 (winter), +02:00 (summer DST)
- DST: yes
- IANA identifier: `Arctic/Longyearbyen`
- Capital: Longyearbyen
...
- IANA timezone: `Arctic/Longyearbyen`
- UTC offset: +01:00 (winter), +02:00 (DST)
- DST: last Sunday March (forward), last Sunday October (back)
- Note: DST is administratively observed but astronomically irrelevant in most of Svalbard's territory

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Norwegian Meteorological Institute (MET Norway)](https://www.met.no/en/)
- [Svalbard Global Seed Vault](https://www.seedvault.no/)
- [The Governor of Svalbard (Sysselmannen)](https://www.sysselmesteren.no/en/)
