...
title: "Time in Sao Tome and Principe: GMT on the Equator, Where the Prime Meridian Meets the Sea"
description: "Sao Tome and Principe observes UTC+0 (GMT) year-round. The island nation sits almost exactly on the intersection of the Prime Meridian (0 degrees longitude) and the Equator, making it the closest inhabited land to the mathematical center of the world's coordinate system."
...
- IANA timezone: `Africa/Sao_Tome`
- UTC offset: +00:00 year-round (since 2018 reversion from UTC+1)
...
- [Instituto Nacional de Meteorologia e Geofísica de São Tomé e Príncipe](https://www.inamet.st/)
- [International Meridian Conference proceedings, 1884](https://www.rmg.co.uk/stories/topics/prime-meridian)
