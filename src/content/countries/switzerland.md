...
country: "Switzerland"
slug: "switzerland"
title: "Time in Switzerland: CET, DST, and the Country That Invented Precision Timekeeping"
description: "Switzerland observes Central European Time (UTC+1 in winter, UTC+2 in summer). It is also home to the world's most precise timekeeping technologies, the country where the atomic clock and the modern wristwatch industry were both pioneered."
...
- Follows EU DST schedule (though Switzerland is not an EU member)

## Sources

- [IANA Time Zone Database](https://data.iana.org/time-zones/tz-link.html)
- [Federal Office of Metrology (METAS), Switzerland](https://www.metas.ch/en/)
- [SBB CFF FFS (Swiss Federal Railways)](https://www.sbb.ch/en/)
- [BIPM: International Bureau of Weights and Measures](https://www.bipm.org/)
- Landes, David. *Revolution in Time: Clocks and the Making of the Modern World*. Harvard University Press, 1983.
