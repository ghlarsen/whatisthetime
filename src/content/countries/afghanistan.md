...
country: "Afghanistan"
slug: "afghanistan"
title: "Time in Afghanistan: UTC+4:30 and the World's Most Unusual Half-Hour"
description: "Afghanistan sits at UTC+4:30, one of only a handful of countries using a 30-minute offset from the hour. It's a timezone that belongs fully to neither its eastern nor western neighbors, and that's entirely the point."
...
- [BIPM — International Bureau of Weights and Measures](https://www.bipm.org/en/time-faq)
...
- [United States Naval Observatory — World Time Zones](https://aa.usno.navy.mil/data/docs/WorldTimeZones.php)
