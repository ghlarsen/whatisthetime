...
country: "India"
slug: "india"
title: "Time in India: UTC+5:30, and the Great Timezone Debate That Never Ends"
description: "India uses a single timezone (IST, UTC+5:30) for a country spanning almost 30 degrees of longitude, and the question of whether the country should split into two timezones has been seriously debated since at least 1980, with no resolution in sight."
...
- Northeast India loses productive morning light
- Energy use in the east is higher because people sleep later than solar time would suggest
- Agricultural workers already operate on unofficial time

Arguments against:
- National unity: a single time is a symbol of one India
- Administrative complexity: rail and aviation scheduling would require major overhaul
- Political sensitivity: the northeast has complex separatist histories, and giving it a separate timezone could be seen as symbolic separation
