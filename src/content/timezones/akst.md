...
timezone: "AKST"
slug: "akst"
title: "AKST Time Now: Alaska Standard Time (UTC-9)"
description: "Alaska Standard Time (AKST) is UTC-9, used across most of Alaska. It shifts to AKDT (UTC-8) in summer. Alaska is the only US state with its own timezone, reflecting its position west of the Pacific coast."
...
- [US Naval Observatory: Timekeeping](https://www.usno.navy.mil/USNO/time)
- [Alaska State Libraries, Archives and Museums](https://lam.alaska.gov/)
