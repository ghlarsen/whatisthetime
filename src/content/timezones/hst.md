...
timezone: "HST"
slug: "hst"
title: "HST Time Now: Hawaii Standard Time (UTC-10)"
description: "Hawaii Standard Time (HST) is UTC-10, used by the state of Hawaii and the outlying US territories in the central Pacific. Hawaii does not observe daylight saving time, making it one of only two US states (along with most of Arizona) on a fixed offset year-round."
iana: ["Pacific/Honolulu", "Pacific/Johnston"]
utcOffset: "-10:00"
...
- [University of Hawaii: Pacific Time Studies](https://www.hawaii.edu/)
- [National Pearl Harbor Remembrance Day](https://www.nps.gov/valr/)
- [Vans Triple Crown of Surfing](https://www.vansus.com/en/surfing)
