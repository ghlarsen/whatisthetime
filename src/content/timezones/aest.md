...
timezone: "AEST"
slug: "aest"
title: "AEST Time Now: Australian Eastern Standard Time (UTC+10)"
description: "Australian Eastern Standard Time (AEST) is UTC+10, covering Sydney, Melbourne, Brisbane, and the Australian east coast. AEDT (UTC+11) operates in summer for NSW, Victoria, Tasmania, and the ACT."
...
Key locations:
- [Sydney](/sydney) (New South Wales, observes AEDT in summer)
...
IANA identifiers:
- `Australia/Sydney` - New South Wales (observes DST)
- `Australia/Melbourne` - Victoria (observes DST)
- `Australia/Brisbane` - Queensland (no DST)
- `Australia/Hobart` - Tasmania (observes DST, slightly different DST transition dates historically)
- `Australia/Lord_Howe` - Lord Howe Island uses a 30-minute DST offset, a further Australian timezone oddity
...
- [Australian Government Attorney-General's Department: Daylight Saving](https://www.ag.gov.au/families-and-marriage/publications/daylight-saving)
- [Sydney Observatory](https://maas.museum/sydney-observatory/)
