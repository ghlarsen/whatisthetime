...
timezone: "HKT"
slug: "hkt"
title: "HKT Time Now: Hong Kong Time (UTC+8)"
description: "Hong Kong Time (HKT) is UTC+8, permanently fixed with no daylight saving time. Hong Kong shares its offset with China Standard Time (CST), Singapore Time, and Philippine Time, but maintains its own IANA identifier and timezone identity."
iana: ["Asia/Hong_Kong"]
utcOffset: "+08:00"
countries: ["Hong Kong"]
